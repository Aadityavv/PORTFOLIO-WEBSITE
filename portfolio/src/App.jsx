...
function App() {
  return (
    <div className="bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 min-h-screen text-white font-sans">
      {/* Indian Army Banner */}
      ...
      {/* Hero Section */}
      <section className="flex flex-col md:flex-row items-center justify-center py-16 px-4 text-center md:text-left min-h-[60vh] animate-fade-in gap-8 md:gap-16">
      ...
      <main className="max-w-screen-lg mx-auto px-4">
        ...
        <section className="py-8 md:py-12">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-4 md:gap-6">
            {skills.map((skill) => (
              <div key={skill.name} className="flex flex-col items-center bg-gradient-to-br from-gray-800/80 to-gray-900/80 rounded-xl p-3 md:p-4 shadow hover:scale-105 transition-transform">
      ...
      {/* Contact Section */}
      <footer className="backdrop-blur-md bg-black/70 py-8 mt-10 text-center shadow-inner">
